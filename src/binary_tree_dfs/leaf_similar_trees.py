...
For example, in the tree [3,5,1,6,2,9,8,null,null,7,4], the leaf value sequence is (6, 7, 4, 9, 8).
...
class Solution:
    def leafSimilar(self, root1, root2):
        """
        Check whether two trees have the same leaf value sequence.
        ...
        Returns:
            bool - true if the trees are leaf-similar
