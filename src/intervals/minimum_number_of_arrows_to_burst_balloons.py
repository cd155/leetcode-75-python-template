...
Output: 2
Explanation: The balloons can be burst by 2 arrows: shoot an arrow at x = 6, bursting the balloons
[2,8] and [1,6]; shoot an arrow at x = 11, bursting the balloons [10,16] and [7,12].
...
Output: 2
Explanation: The balloons can be burst by 2 arrows: shoot an arrow at x = 2, bursting the balloons
[1,2] and [2,3]; shoot an arrow at x = 4, bursting the balloons [3,4] and [4,5].
...
class Solution:
    def findMinArrowShots(self, points):
        ...
        Args:
            points: List[List[int]] - balloon intervals [xstart, xend]
...
if __name__ == "__main__":
    ...
    # Test case 3
    result = solution.findMinArrowShots([[1, 2], [2, 3], [3, 4], [4, 5]])
