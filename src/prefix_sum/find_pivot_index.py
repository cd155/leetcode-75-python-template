...
Output: 3
Explanation: Left sum = nums[0] + nums[1] + nums[2] = 1 + 7 + 3 = 11. Right sum = nums[4] + nums[5]
= 5 + 6 = 11.
...
Input: nums = [2,1,-1]
Output: 0
Explanation: Left sum = 0 (no elements to the left of index 0). Right sum = nums[1] + nums[2] = 1 +
-1 = 0.
...
class Solution:
    def pivotIndex(self, nums):
        ...
        Returns:
            int - leftmost pivot index, or -1 if none exists
