...
Input: rooms = [[1],[2],[3],[]]
Output: true
Explanation: We visit room 0 and pick up key 1. We then visit room 1 and pick up key 2. We then
visit room 2 and pick up key 3. We then visit room 3. Since we were able to visit every room, we
return true.
...
class Solution:
    def canVisitAllRooms(self, rooms):
        """
        Check whether every room can be visited starting from room 0.

        Args:
            rooms: List[List[int]] - keys found in each room
