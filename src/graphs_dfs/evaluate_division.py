...
Example 1:
Input: equations = [["a","b"],["b","c"]], values = [2.00000,3.00000], queries = [["a","c"],["b","a"],["a","e"],["a","a"],["x","x"]]
Output: [6.00000,0.50000,-1.00000,1.00000,-1.00000]
Explanation: Given: a / b = 2.0, b / c = 3.0. queries are: a / c = ?, b / a = ?, a / e = ?, a / a =
?, x / x = ?. return: [6.0, 0.5, -1.0, 1.0, -1.0]. Note: x is undefined => -1.0

Example 2:
Input: equations = [["a","b"],["b","c"],["bc","cd"]], values = [1.50000,2.50000,5.00000], queries = [["a","c"],["c","b"],["bc","cd"],["cd","bc"]]
...
class Solution:
    def calcEquation(self, equations, values, queries):
        """
        Evaluate division queries using the given equations.

        Args:
            equations: List[List[str]] - variable pairs [Ai, Bi]
            values: List[float] - value of Ai / Bi for each equation
            queries: List[List[str]] - variable pairs [Cj, Dj] to evaluate

        Returns:
            List[float] - answer to each query, or -1.0 if it cannot be determined
