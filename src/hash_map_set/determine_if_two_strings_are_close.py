...
Output: true
Explanation: You can attain word2 from word1 in 2 operations. Apply Operation 1: "abc" -> "acb".
...
Output: true
Explanation: You can attain word2 from word1 in 3 operations. Apply Operation 1: "cabbba" ->
"caabbb". Apply Operation 2: "caabbb" -> "baaccc". Apply Operation 2: "baaccc" -> "abbccc".
...
class Solution:
    def closeStrings(self, word1, word2):
        """
        Check whether two strings are close.
        ...
        Returns:
            bool - true if the strings are close
